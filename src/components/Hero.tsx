  ...
  return (
    <section id="home" className="relative h-screen min-h-[600px] overflow-hidden">
      ...
      {slides.map((s, i) => (
        <div
          key={i}
          className={`absolute inset-0 transition-opacity duration-1000 ${i === current ? 'opacity-70' : 'opacity-0'}`}
        >
          <img
            src={s.image}
            alt={s.title}
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4">
        ...
        <p className="text-white/100 text-base md:text-lg leading-relaxed mb-10 max-w-xl">
          {slide.subtitle}
        </p>
