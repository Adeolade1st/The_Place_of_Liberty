...
const impactTiers = [
  { amount: '₦50,000', label: 'Monthly', impact: 'Sponsors one child\'s monthly medication costs' },
  { amount: '₦150,000', label: 'Quarterly', impact: 'Three months of uninterrupted treatment for a child' },
