...
const allImages: { src: string; alt: string; category: Exclude<Category, 'All'>; caption: string }[] = [
  ...
  {
    src: 'https://images.pexels.com/photos/5212700/pexels-photo-5212700.jpeg?auto=compress&cs=tinysrgb&w=900',
    alt: 'Art therapy session',
    category: 'Therapy',
    caption: 'Art therapy helps children express emotions and build fine motor skills.',
  },
  {
    src: 'https://images.pexels.com/photos/3769714/pexels-photo-3769714.jpeg?auto=compress&cs=tinysrgb&w=900',
    alt: 'Reading time',
    category: 'Classroom',
    caption: 'Storytime sessions nurture language development and imagination.',
  },
  {
    src: 'https://images.pexels.com/photos/8613320/pexels-photo-8613320.jpeg?auto=compress&cs=tinysrgb&w=900',
    alt: 'Group activity',
    category: 'Activities',
    caption: 'Group activities build teamwork, communication, and social bonds.',
  },
  {
    src: 'https://images.pexels.com/photos/5212695/pexels-photo-5212695.jpeg?auto=compress&cs=tinysrgb&w=900',
    alt: 'Teacher with student',
    category: 'Classroom',
    caption: 'One-on-one teaching time ensures every child gets personalised attention.',
  },
  {
    src: 'https://images.pexels.com/photos/8613060/pexels-photo-8613060.jpeg?auto=compress&cs=tinysrgb&w=900',
    alt: 'Sensory play',
    category: 'Therapy',
    caption: 'Sensory integration activities help children regulate and focus.',
  },
  {
    src: 'https://images.pexels.com/photos/3769983/pexels-photo-3769983.jpeg?auto=compress&cs=tinysrgb&w=900',
    alt: 'Outdoor play',
    category: 'Activities',
    caption: 'Outdoor play promotes physical development and wellbeing.',
  },
  {
    src: 'https://images.pexels.com/photos/8363104/pexels-photo-8363104.jpeg?auto=compress&cs=tinysrgb&w=900',
    alt: 'Speech therapy',
    category: 'Therapy',
    caption: 'Speech therapy sessions support communication development.',
  },
  {
    src: 'https://images.pexels.com/photos/1001914/pexels-photo-1001914.jpeg?auto=compress&cs=tinysrgb&w=900',
